...
const config = {
    ...
    scenarios: {
        gbaWealthOpportunity: {
            ...
            steps: [
                { text: "‼️ OPPORTUNITY: GBA Strategy Agent detects a significant liquidity event for a high-net-worth client in Shenzhen.", bubble: ["gba-strategy", "GBA client liquidity event!"], agent: "gba-strategy", type: 'event', handoffTo: "wealth-advisor",
                  ...
                  challenge: "<h3>Trusted & Contextual Data</h3><p>How can the agent trust the external data? How does it connect that external event to a specific internal client record securely and accurately? The foundation for this is a trusted, contextual data estate.</p><p><strong>Potential Solutions:</strong></p><ul><li>Leverage <strong>watsonx.data</strong> to create a governed data lakehouse, allowing the agent to query both internal client data and curated external market intelligence from a single point of access.</li><li>This ensures the agent's insights are built on a trusted, complete view of the client and the market.</li></ul>"
                },
                { text: "📈 AI Wealth Advisor drafts a personalized, cross-border investment proposal (e.g., Wealth Management Connect).", bubble: ["wealth-advisor", "Drafting personalized proposal."], agent: "wealth-advisor",
        ...
        smeTradeFinance: {
            ...
            steps: [
                { text: "‼️ INCOMING: An SME client submits a trade finance application via the portal with supporting documents.", bubble: ["sme-service", "New trade finance application."], agent: "sme-service", type: 'event', handoffTo: "fraud-detection",
                  ...
                  challenge: "<h3>Data Extraction Accuracy</h3><p>The success of the entire workflow depends on the agent's accuracy in extracting data from diverse and often low-quality documents. An error here could derail the entire process.</p><p><strong>Potential Solutions:</strong></p><ul><li>Utilize the powerful document understanding capabilities within <strong>watsonx Orchestrate</strong> to build a resilient ingestion process that can handle a wide variety of document formats and layouts with high accuracy.</li></ul>"
                },
                { text: "🛡️ Fraud Detection Agent analyzes the transaction for trade-based money laundering (TBML) indicators.", bubble: ["fraud-detection", "Screening for TBML risk..."], agent: "fraud-detection",
        ...
        aiopsResilience: {
            ...
            steps: [
                 { text: "‼️ ALERT: Resilience Ops Agent detects high API error rates for GBA customers using the mobile app.", bubble: ["resilience-ops", "High API errors for GBA users!"], agent: "resilience-ops", type: 'event', handoffTo: "resilience-ops",
